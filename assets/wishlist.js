...
<head>
  ...
  {{ 'your-existing-image.png' | image_url | image_tag: preload: true, alt: 'Preloaded image' }}
  ...
  <script src="{{ 'sentry-bundle.tracing.min.js' | asset_url }}" crossorigin="anonymous" defer></script>
  <script>
    Sentry.init({
  ...
  <div class="header-sticky-group">
    ...
    <div class="top-social-bar">
      ...
      <div class="language-selector-right">
        <a href="/fr"><img src="{{ 'flag-fr.png' | asset_url }}" class="flag-icon" alt="FR" width="24" height="16"></a>
        <a href="{{ routes.root_url }}"><img src="{{ 'flag-en.png' | asset_url }}" class="flag-icon" alt="EN" width="24" height="16"></a>
        <a href="/de"><img src="{{ 'flag-de.png' | asset_url }}" class="flag-icon" alt="DE" width="24" height="16"></a>
      </div>
    </div>
    {% section 'discount-bar' %}
    <div class="announcement-text shipping-notice">
      {% assign lang = request.locale.iso_code %}
      <a href="{% if lang == 'fr' %}/fr/pages/eee{% elsif lang == 'de' %}/de/pages/eee{% else %}/pages/eee{% endif %}">{{ 'announcement.shipping_notice' | t }}</a>
    </div>
    {% section 'navbar' %}
